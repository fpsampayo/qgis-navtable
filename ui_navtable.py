...
from qgis.PyQt.QtWidgets import QCheckBox, QPushButton, QWidget, QGridLayout, QLabel, QLineEdit, QTableWidget, QTableWidgetItem, QAbstractItemView
...
class Ui_Navtable(object):
    def setupUi(self, Navtable):
        ...
        self.selectCB = QCheckBox(Navtable)
